...
<body>
		...
		<div class="heade-con">
			...
			<div class="nav posa">
				<ul>
					...
					<li><a href="/crowdfunding/zhuan/to_gyzc-list">公益众筹</a>
					</li>
					<li><a href="/crowdfunding/zhuan/to_cop">常见问题</a>
					</li>
					<li><a href="/crowdfunding/zhuan/to_ly-list">众筹资讯</a>
					</li>
	...
	<div class="user-con">
		<div class="user-conl">
			<ul>
				<li><b class="a-tit" href="">项目管理</b>
				</li>
				<li><i class="i1"></i><a class="u-hover" href="">发起的项目</a>
				</li>
				<li><i class="i2"></i><a href="">参与的项目</a>
				</li>
				<li><i class="i4"></i><a href="">点赞的项目</a>
				</li>
				<li><i class="i6"></i><a href="">资金管理</a>
				</li>
				<li><b class="a-tit" href="">消息管理</b>
				</li>
				<li><i class="i4"></i><a href="">我的评论</a>
				</li>
				<li><i class="i4"></i><a href="">我的私信</a>
				</li>
				<li><b class="a-tit" href="">个人设置</b>
				</li>
				<li><i class="i7"></i><a href="/crowdfunding/user/to_update">资料修改</a>
				</li>
				<li><i class="i8"></i><a href="">安全信息</a>
				</li>
				<li><i class="i9"></i><a href="">收件地址管理</a>
				</li>
				<li><i class="i10"></i><a href="">实名认证</a>
				</li>
			</ul>
		</div>
		<div class="user-conr">
						...
						<table width="700px" height="300px" border="1px">
							...
							<c:forEach items="${list }" var="p">
								<tr align="center">
									...
									<td>${p.pMoney }</td>
									<td>${p.pRaise }</td>
									<fmt:formatDate value="${p.pStime }" pattern="yyyy-MM-dd" var="d"/>
									<td>${d }</td>
									<td>${p.pState }</td>									
								</tr>
							</c:forEach>
	...
	<div id="bottom">
		<div class="bot-con1">
			<ul>
				...
				<li>单项支持人数<span class="inde-span1"></span>
				</li>
				<li>单项筹款金额<span class="inde-span2"></span>
				</li>
				<li>累计筹款金额<span class="inde-span3"></span>
				</li>
			</ul>
		</div>
		...
		<div class="footer-bd">
			...
			<span>网络文化经营许可证：<a href=" ">浙网文[2013]0268-027号</a>
			</span> <b>|</b> <span data-spm-protocol="i">增值电信业务经营许可证：<a href="">浙B2-20080224-1</a>
